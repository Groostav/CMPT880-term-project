// Thid test tries to expose C at : benchmarks/instrumented/java17/lang/StringBuffer.java#144
// with R at : benchmarks/instrumented/java17/lang/AbstractStringBuilder.java#763
// accessing fied: [I2, count]
import java.util.*;
import java.io.*; 
...
public class TestDriver5{ 
    ...
    public static void imposeConstraint() { 
        ...
        Parameter racy = racyParameters0.get(2);
    ...
    * Test for the race.
    ...
    public static void main(String args[]) { 
        ...
        /* Objects collected from run : 2
         Invocation of method : deleteCharAt
        Line : 27 in StringBufferTest*/
