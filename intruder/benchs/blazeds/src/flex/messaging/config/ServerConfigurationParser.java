...
public abstract class ServerConfigurationParser extends AbstractConfigurationParser
{
    ...
    private void channelDefinition(Node channel)
    {
        ...
        if (isValidID(id))
        {
            ...
            // A channel should either have a class or server-only attribute, but not both.
    ...
    private void destinationInclude(Node destInclude, ServiceSettings serviceSettings)
    {
        ...
        if (src.length() > 0)
        {
            ...
            // Check for multiple destination includes.
            ...
            else // Check for single destination include.
            {
                ...
                {
                    //The destination include root element must be '{DESTINATIONS_ELEMENT}' or '{DESTINATION_ELEMENT}'.
                    ConfigurationException ex = new ConfigurationException();
