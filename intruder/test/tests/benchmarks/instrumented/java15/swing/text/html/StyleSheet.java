...
public class StyleSheet extends StyleContext {
    ...
    public AttributeSet addAttributes(AttributeSet old, AttributeSet attr) {
        //MKR comments to make this compile without getting the HTMLDocument file locally
    ...
    public static class BoxPainter implements Serializable {
        ...
        public void paint(Graphics g, float x, float y, float w, float h, View v) {
            ...
            float localRightMargin = getOrientationMargin(HorizontalMargin.RIGHT,
                                                          rightMargin,
                                                          a, isLeftToRight);
            //MKR Comments to get this to compile without HTMLEditorKit.java
        ...
        private CSS.Value getChildType(View childView) {
            ...
            if (childtype == null) {
                if (type == null) {
                    ...
                    // MKR Comments to make this compile without HTMLDocument locally; 
