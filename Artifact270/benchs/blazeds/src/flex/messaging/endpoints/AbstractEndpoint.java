        ...
        implements Endpoint2, ConfigurationConstants
{
    ...
    public void initialize(String id, ConfigMap properties)
    {
        ...
        if (serialization != null)
        {
            ...
            // Max Object Nest Level configuration
     ...
     * @return False if the set already contains the url.
     *
     */
     ...
     * @return True if the set contained the url.
     */
    ...
    /**
     * Returns a snapshot of the current client-load-balancing urls.
     *
    ...
    /**
     * Returns <code>true</code> if the endpoint clients connect to directly is mirrored and running
     ...
     * a local representation of a symmetric endpoint on a remote host that will.
     */
    ...
    /**
     * Returns whether the endpoint is server only.
     *
     * @return True if the endpoint is server only.
     */
